...
Use this template when adding new features to FATI-PROJET.

## Instructions
1. Copy the entire template below
2. Fill in the placeholders with your feature description
3. Paste into a new Copilot chat
4. Copilot will create all necessary files
...
**Feature Name:** [DESCRIBE FEATURE NAME]
