...
<div class="max-w-3xl mx-auto p-10 rounded-[2.5rem] shadow-neumorphic bg-neu-base">
    <form action="{{ route('admin.quizzes.store') }}" method="POST" class="space-y-8">
        ...
        <div>
            <x-input-label for="lesson_id" value="Associated Module" />
            ...
            <p class="text-[10px] text-slate-400 mt-2 italic">This assessment will be accessible to all cohorts assigned to the selected module.</p>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-slate-400 mt-1 italic">e.g. 80 for 80%</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <x-input-label for="scheduled_at" value="Schedule Date (Optional)" />
            ...
            <div class="pt-6">
                <label class="flex items-center cursor-pointer space-x-4">
                    ...
                    <div>
                        <span class="text-sm font-black text-gray-700 uppercase tracking-widest">Activate Now</span>
                        <p class="text-[10px] text-gray-400">If unchecked, students won't see this quiz.</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="flex gap-4 pt-6">
            <a href="{{ route('admin.quizzes.index') }}" class="flex-1 py-4 text-center rounded-2xl shadow-neumorphic-btn font-bold text-gray-500 transition hover:shadow-neumorphic-btn-active">Annuler</a>
